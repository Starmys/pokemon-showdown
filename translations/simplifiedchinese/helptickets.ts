...
export const translations: Translations = {
	strings: {
		"Hello! The global staff team would be happy to help you, but you need to explain what's going on first.": "您好！全服管理团队很高兴为您服务！请说明您的需求。",
		"Please post the information I requested above so a global staff member can come to help.": "请说明您的需求以便管理团队为您提供帮助。",
		"Thank you for the information, global staff will be here shortly. Please stay in the room.": "感谢您提供的信息，请勿离开房间，管理员会尽快与您联系。",
		"You are banned from creating tickets": "您被禁止提交新的工单",
		", because you have the same IP as ${ticket.banned}.": ", 因为您的IP地址与 ${ticket.banned} 相同。",
		"Request help from global staff": "向全服管理团队请求帮助",
		"Please <button name=\"login\" class=\"button\">Log In</button> to request help.": "请先 <button name=\"login\" class=\"button\">登录</button> 再请求帮助。",
		"Request Help": "请求帮助",
		"You already have a Help ticket.": "在上一个工单处理结束之前, 您不能提交新的工单。",
		"Back": "返回",
		"What's going on?": "您遇到了什么问题？",
		"Global staff cannot make Help requests. This form is only for reference.": "全服管理团队成员不能提交工单。下列内容仅供参考。",
		"Abuse of Help requests can result in punishments.": "滥用工单会受到惩罚。",
		"What do you want to report someone for?": "您举报的行为是？",
